  ...
  return (
    <div className="legal-page">
      ...
      <ul>
        ...
        <li>
          <strong>Businessplan-Inhalte:</strong> die von dir eingegebenen Antworten und Zahlen sowie die von Claude erzeugten Texte. Wir speichern diese, um deinen Plan über Sitzungen hinweg verfügbar zu machen.
        </li>
        <li>
